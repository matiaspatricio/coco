...
<div class="ps-page--shop" id="shop-categories" style="padding-top: 50px;">
    ...
    <div class="container">
        ...
        <div class="ps-page--shop" id="shop-categories" style="">
            ...
            <div class="mb-5">
                <h3 class="text-center">Ofertar un servicio</h3>
            </div>
            ...
            <div class="jumbotron" style="background-color: #fff;display: none;" id="paso_1" >
                ...
                <p class="lead">
                    Indicá el servicio que ofrecés.
                </p>
                <hr class="my-4">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="titulo" value="Solicito electricista">
                    </div>
                </div>  
                ...
                <div class="row mt-3">
                    <div class="col-3">
                        ...
                        <input type="text" class="form-control" id="anios_experiencia">
                    </div>
                </div>

                <div class="row mt-3">
                    <div class="col-12">
                        <label for="">¿Incluye gastos de movilidad?</label>
                        PENDING
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <label for="que_incluye">¿Qué incluye? <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="que_incluye" rows="2"></textarea>
                    </div>
                </div>

                <div class="row mt-3">
                    <div class="col-12">
                        <label for="que_no_incluye">¿Qué no incluye? <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="que_no_incluye" rows="2"></textarea>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="mas_informacion" rows="2"></textarea>
                    </div>
                </div>
            ...
            <div class="jumbotron mt-3" style="background-color: #fff;display: none;" id="paso_2">
                ...
                <p class="lead">
                    Ingresá una descripción de tu publicación.
                </p>
                <hr class="my-4">
