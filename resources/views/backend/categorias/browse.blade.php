...
@section("modals")
    ...
    @component('backend.template.modal_agregar')
        ...
        @slot('inputs')
            ...
            <div class="col-md-12">
                <label for="mostrar_en_menu_agregar">Mostrar en menú <span class="text-danger">*</span></label>
    ...
    @component('backend.template.modal_editar')
        ...
        @slot('inputs')
            ...
            <div class="col-md-12">
                <label for="mostrar_en_menu_editar">Mostrar en menú <span class="text-danger">*</span></label>
...
$(document).ready( function () {
    ...
    $("#cambiar_imagen_agregar").dropzone({
        ...
        url: "{{url('/backend/upload_imagen_categoria')}}",
        acceptedFiles: 'image/*',
        paramName: "file",
                ...
                xhr.onreadystatechange = function() {
                    ...
                    if (xhr.readyState == XMLHttpRequest.DONE) {
                        ...
                        if(respuesta["done"] == undefined)
                        {
                            ...
                            $("#preview_imagen_agregar").attr("src","{{asset('/storage/imagenes/categorias')}}/"+file_name);
                ...
                xhr.onreadystatechange = function() {
                    ...
                    if (xhr.readyState == XMLHttpRequest.DONE) {
                        ...
                        if(respuesta["done"] == undefined)
                        {
                            ...
                            $("#preview_imagen_editar").attr("src","{{asset('/storage/imagenes/categorias')}}/"+file_name);
        ...
        success: function(data)
        {
            ...
            try
            {
              if(data["response"] == true)
              {
                ...
                $("#preview_imagen_editar").attr("src","{{ asset('/storage/imagenes/categorias') }}/"+data["data"]["imagen"]); 
