...
@section("modals")
    ...
    @component('backend.template.modal_agregar')
        ...
        @slot('inputs')
            ...
            <div class="col-md-12">
                <label for="color_agregar">Color</label>
                <input type="text" class="form-control colorpicker" id="color_agregar" name="color" readonly="" style="background-color: #fff !important">
            </div>
    ...
    @component('backend.template.modal_editar')
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control colorpicker" id="color_editar" name="color" style="background-color: #fff !important;">
            </div>
        @endslot
    @endcomponent
...
function abrir_modal_agregar()
{
    ...
    $("#formulario_agregar select").val(0);
...
function agregar()
{
    ...
    formdata.append("color",$("#formulario_agregar [name=color]").val());
        ...
        success: function(data)
        {
            ...
            try
            {
              if(data["response"] == true)
              {
                ...
                $("#color_editar").val(data["data"]["color"]).trigger("change");
...
function editar()
{
    ...
    formdata.append("color",$("#formulario_editar [name=color]").val());
