...
@section("modals")
    ...
    @component('backend.template.modal_agregar')
        ...
        @slot('inputs')
            <div class="col-md-12">
                <label for="talle_agregar">Talle <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="talle_agregar" name="talle">
            </div>
        @endslot
    @endcomponent
    ...
    @component('backend.template.modal_editar')
        ...
        @slot('inputs')
        <div class="col-md-12">
                <label for="talle_editar">Talle <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="talle_editar" name="talle">
            </div>
        @endslot
    @endcomponent
...
function agregar()
{
    ...
    formdata.append("talle",$("#formulario_agregar [name=talle]").val());
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            try
            {
              ...
              {
                id_trabajando = id;
                $("#talle_editar").val(data["data"]["talle"]);
...
function editar()
{
    ...
    formdata.append("talle",$("#formulario_editar [name=talle]").val());
