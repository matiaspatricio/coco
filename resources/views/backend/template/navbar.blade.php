<div class="main-header">
	...
	<div class="logo-header" data-background-color="blue">
		...
		<a href="index.html" class="logo">
			<img src="{{ asset('/admin/assets/img/logo_sidebar.png') }}" alt="navbar brand" class="navbar-brand img-fluid">
		</a>
				...
				<li class="nav-item dropdown hidden-caret">
					...
					<ul class="dropdown-menu dropdown-user animated fadeIn">
						<div class="dropdown-user-scroll scrollbar-outer">
							<li>
								<div class="user-box">
									<div class="avatar-lg"><img src="{{ asset('storage/imagenes/usuarios/'.session('foto_perfil')) }}" alt="image profile" class="avatar-img rounded"></div>
									<div class="u-text">
										<h4>{{session("nombre")}}</h4>
										<p class="text-muted">{{session("correo")}}</p>
										<a href="{{url('/backend/perfil/mi_perfil')}}" class="btn btn-xs btn-secondary btn-sm">
											Ver Perfil
										</a>
									</div>
								</div>
							...
							<li>
								...
								<a class="dropdown-item" href="{{url('/backend/perfil/mi_perfil')}}">Mi Perfil</a>
								<a class="dropdown-item" href="#">Mi Cuenta</a>
								<a class="dropdown-item" href="#">Mensajes</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="#">Configuracion de Cuenta</a>-->
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="{{url('/backend/cerrar_sesion')}}">Cerrar Sesion</a>
							</li>
						</div>
					</ul>
				</li>
